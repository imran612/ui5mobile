sap.ui.jsview("com.jabil.lnclr.mob.view.DocumentList", {
	...
	createContent: function (oController) {
            ...
            {contentLeft: [new sap.m.Button({icon:"sap-icon://nav-back",press:oController.handleNavBack}),new sap.m.Image("jblLogo1",{src:"img/jabil-logo.jpg",height:"30px"})],contentRight:[new sap.m.Button({text:"Selection Screen"}),new sap.m.Button({icon:"sap-icon://log"}) ]}));
